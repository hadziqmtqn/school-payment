                ...
                <form onsubmit="return false" id="formEdit" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class="col-12 fv-plugins-icon-container">
                        <div class="form-floating form-floating-outline mb-3">
                            <input type="number" class="form-control" name="first_year" id="editFirstYear" placeholder="Tahun Awal">
                            <label for="editFirstYear">Tahun Awal</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-3">
                            <input type="number" class="form-control" name="last_year" id="editLastYear" placeholder="Tahun Akhir">
                            <label for="editLastYear">Tahun Akhir</label>
                        </div>
